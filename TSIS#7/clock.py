...
clock1 = Background('Pygame/images/mickey.clock.jpg', (0, 0))

minute_hand_image = pygame.image.load("Pygame/Images/hour.jpg").convert_alpha()
second_hand_image = pygame.image.load("Pygame/Images/seconds.jpg").convert_alpha()
