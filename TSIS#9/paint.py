    ...
    if click[0] == 1:
        if shape == "rect":
            pygame.draw.rect(window, draw_color,
                             (mouse_pos[0], mouse_pos[1], 50, 20), draw_size)
        elif shape == "circle":
            pygame.draw.circle(window, draw_color, mouse_pos, 25, draw_size)
        elif shape == "square":
            pygame.draw.rect(window, draw_color,
                             (mouse_pos[0], mouse_pos[1], 50, 50), draw_size)
        elif shape == "rtriangle":
            pygame.draw.polygon(window, draw_color, ((mouse_pos[0], mouse_pos[1]), (
                mouse_pos[0], mouse_pos[1]+50), (mouse_pos[0]+50, mouse_pos[1])))
        elif shape == "rhombus":
            size = 50
            ...
            pygame.draw.polygon(window, draw_color, [
                                top_left, top_right, bottom_right, bottom_left])
        elif shape == "etriangle":
            side_length = 50
            center_x, center_y = pygame.mouse.get_pos()
            vertex1 = (center_x, center_y - side_length)
            vertex2 = (center_x - side_length * math.sin(math.pi / 3),
                       center_y + side_length * math.cos(math.pi / 3))
            vertex3 = (center_x + side_length * math.sin(math.pi / 3),
                       center_y + side_length * math.cos(math.pi / 3))
            pygame.draw.polygon(window, draw_color, [
                                vertex1, vertex2, vertex3])
        elif shape == "eraser":
            pygame.draw.rect(
                window, BLACK, (mouse_pos[0], mouse_pos[1], 40, 40), draw_size)
